...
public class PayController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<?> pay(@PathVariable UUID id) throws UnsupportedEncodingException {
        ...
        long amount = (long) (hd.getTongTienKhiGiam()*100);
        String bankCode = "NCB";
    ...
    public ResponseEntity<?> payInOnline(@RequestParam("tien") long tien) throws UnsupportedEncodingException {
        ...
        vnp_Params.put("vnp_Locale", "vn");
        vnp_Params.put("vnp_ReturnUrl", "http://localhost:3000/#/trang-chu");
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
